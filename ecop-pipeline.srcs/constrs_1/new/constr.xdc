...
set_property PACKAGE_PIN U2 [get_ports {LedSw[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {LedSw[0]}]
set_property PACKAGE_PIN U4 [get_ports {LedSw[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {LedSw[1]}]
set_property PACKAGE_PIN V4 [get_ports {LedSw[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {LedSw[2]}]
set_property PACKAGE_PIN W4 [get_ports {LedSw[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {LedSw[3]}]


##Buttons
set_property PACKAGE_PIN U18 [get_ports ClkBtn]
set_property IOSTANDARD LVCMOS33 [get_ports ClkBtn]
